...
//! it observed. It holds no database and evaluates no policy — the runtime decided all of that before
//! dispatching, and a worker that re-decided would be a second authority.
#![forbid(unsafe_code)]
