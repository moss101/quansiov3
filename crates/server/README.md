...
**Canonical owner:** `crates/server` — quansio-server: authoritative API, control, runtime, policy, effects, scheduler and artifact composition.
...
Build: `cargo test -p quansio-server`
